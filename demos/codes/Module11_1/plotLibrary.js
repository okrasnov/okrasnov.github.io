...
function doModule11_1(inputs) {
    ...
    var a=[];
        ...
        for (var i = 0; i <= 70; i += 1) {
            ...
            a = S2RTR_DiffuseUB(real_eps1,-imag_eps1,freq,rmsheight,
                                albedo,kappa_e,thickness, theta);
    ...
    $.plot($("#plotModule11_1"), [ data_hh, data_vv, d3 ], options);
